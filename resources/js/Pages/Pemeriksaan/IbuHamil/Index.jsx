        ...
        <AuthenticatedLayout header={<span>Layanan Posyandu <span className="text-seafoam-500 mx-2">/</span> Pemeriksaan Ibu Hamil</span>}>
            ...
            <div className="space-y-6">
                ...
                <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100">
                    <div className="flex items-center gap-4 w-full md:w-auto">
                        <div className="relative w-full md:w-80 group">
                            ...
                            <input 
                                ...
                                className="w-full rounded-2xl border-none bg-slate-50 py-3.5 pl-11 pr-4 text-xs font-bold text-slate-600 focus:ring-4 focus:ring-seafoam-500/10 transition-all" 
                                value={searchQuery} 
                    ...
                    <PrimaryButton onClick={() => openModal()} className="rounded-2xl px-6 py-3.5 bg-rose-500 hover:bg-rose-600 border-none font-bold text-white text-[10px] uppercase tracking-widest shrink-0">
                        + Catat Pemeriksaan
                    </PrimaryButton>
                </div>
